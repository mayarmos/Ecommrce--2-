...
//  <input type="text"placeholder="Search for products..."value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full p-2 border-2 rounded-lg "/>
//           </div>
//           <div className={styles.row}>
//             {filteredProducts.length > 0 ? (
//               filteredProducts.map((productInfo) => (
...
//                     </Link>
//                     <button onClick={() => { addproductItem(productInfo.id) }} className={styles.btn}>Add to cart</button>
//                     <button onClick={() => { addWishListItem(productInfo.id) }} className='text-center'>
